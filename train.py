...
parser.add_argument('--vocab_size', type=int, default=3500, metavar='V')
...
parser.add_argument('--db_size', type=int, default=18)
parser.add_argument('--bs_size', type=int, default=14)
...
if __name__ == '__main__':
    ...
    model = model.Model(args, input_lang_index2word, output_lang_index2word, input_lang_word2index, output_lang_word2index)
    if args.load_param:
